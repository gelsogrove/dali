...
A full-stack property management system with Docker containerization, built with PHP 8.3, MariaDB 10.6, and React + TypeScript.

## 🚀 Features

### ⚠️ Repository Pubblico - Sicurezza

**IMPORTANTE**: Questo repository è pubblico su GitHub.
- ❌ Nessuna password nel codice
- ❌ File `.env` contiene solo placeholder
- ✅ Password configurate solo sul server
...
- Image upload with automatic resizing (4 sizes)
- Video upload support
- Photo gallery management
- Activity logging and audit trail
- Role-based access control

### Frontend Admin Panel (React + TypeScript + shadcn/ui)
