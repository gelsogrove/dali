...
CREATE TABLE properties (
    ...
    interior_sqm DECIMAL(10,2) DEFAULT NULL COMMENT 'Interior size in square meters',
    interior_sqft DECIMAL(10,2) DEFAULT NULL COMMENT 'Interior size in square feet',
    exterior_sqm DECIMAL(10,2) DEFAULT NULL COMMENT 'Exterior size in square meters',
    exterior_sqft DECIMAL(10,2) DEFAULT NULL COMMENT 'Exterior size in square feet',
